...
<head>
	<meta charset="UTF-8">
	<title>Blog Single || MechanicHub || Responsive HTML 5 Template</title>
                    ...
                    <div class="navbar-collapse collapse clearfix">
                        <ul class="navigation clearfix">
                            ...
                            <li class="dropdown"><a href="about.html">About us</a>
                                <ul>
                                    <li><a href="about.html">About Mechanichub</a></li>
                            ...
                            <li class="dropdown"><a href="services.html">Services</a>
                                <ul>
                                    ...
                                    <li><a href="ser-single1-wheel-works.html">Wheel Works</a></li>
                                    <li><a href="ser-single2-painting-works.html">Painting Works</a></li>
                                    <li><a href="ser-single3-air-conditioner.html">Air Conditioner</a></li>
                                    <li><a href="ser-single4-water-service.html">Water Service</a></li>
                                    <li><a href="ser-single5-engine-works.html">Engine Works</a></li>
                                    <li><a href="ser-single6-lube-oil-filters.html">lube Oil & Filters</a></li>
                                    <li><a href="ser-single7-brake-repairs.html">Brake Repairs</a></li>
                                    <li><a href="ser-single8-belts-hoses.html">Belts & Hoses</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown current"><a href="blog-grid.html">Blog</a>
                                <ul>
                ...
                <div class="blog-post">
                    <div class="single-blog-item wow fadeInUp" data-wow-delay="0s" data-wow-duration="1s" data-wow-offset="0">
                        ...
                        <div class="text-holder">
                            <h3 class="blog-title">Simulation of Customers’ Booking Behavior...</h3>
                            <ul class="meta-info">
                                <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i> Jacky</a></li>
                                <li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 58 Views</a></li>
                                <li><a href="#"><i class="fa fa-comment" aria-hidden="true"></i> 10 Comments</a></li>
                                <li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i> Wheels, Mechanics</a></li>
                            </ul>
                            <div class="text">
                                <p class="mar-btm">Simulation helps us out when we want to find out more about a crystal ball helping a wizard predict the future a lot of auto repair customerss question the importance of wheel alignment. Is it really necessary? Yes, it is master builder of human happiness how to pursue pleasure rationally encounter.</p>
                                
                                <p>A lot of auto repair customerss questions the importance of wheel alignment. Is it really necessary? Yes, it is. Masters builder of human happiness. No one rejects, dislikes, or utavoids pleasures itself, because it is pleasures, but because those who do not know how to pursue pleasure rationally encounter shopping around town for the lowest gas prices, we have found a great video that gives some extra money saving tips.</p>
                            </div>
                            <div class="project-manager">
                                <p>Fusce et purus sit amet erat fermentum rutrum. Pellentesque pellentesque auctor vehicula. Integer ut ligula blandit, pellentesque neque in, hendrerit magna. Nunc porta vehicula mauris, a hendrerit dolor dignissim fermentum aecenas tincidunt finibus auctor.</p>
                                <h3>E. Douglas - <span>Manager</span></h3>
                            </div>
                            <div class="middle-content-box">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-holder">
                                            <h2>Tips fo Car Maintenance</h2>
                                            <p>Perspiciatis unde omnis iste natus errors sit voluptatem accusantium doloremques laudantium, totam rem seds aperiam, inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                            <ul>
                                                <li><i class="fa fa-angle-right" aria-hidden="true"></i> Engine oil level should be regularly checked</li>
                                                <li><i class="fa fa-angle-right" aria-hidden="true"></i> Tyres have a minimum of 1.6mm of tread depth</li>
                                                <li><i class="fa fa-angle-right" aria-hidden="true"></i> Ensure that your vehicle's brake fluid is full</li>
                                                <li><i class="fa fa-angle-right" aria-hidden="true"></i> Never remove the radiator cap when the engine is hot</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="text-holder">
                                    ...
                                    <p>Similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. uni seds harum quidem sed rerum facilis est et expedita distinctio. Nam libero tempore, cums soluta nobis est eligendi optio cumque nihilares impedit quo repellendus eligendi.</p>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="single-comment-box">
                                    ...
                                    <div class="text-holder">
                                        ...
                                        <div class="text">
                                            <p>If your delts are a weakness, or you find it's muscle group you have all seds a hard time connecting with, this workout will help. You'll feel a huge amount.</p>
                                ...
                                <div class="single-comment-box">
                                    ...
                                    <div class="text-holder">
                                        ...
                                        <div class="text">
                                            <p>I started using weight plates in my shoulder ut workouts instead of dumbbells barbells thought that seds, by increasing the length of the lever.</p>
                                            <a class="reply" href="#">Reply</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="sidebar-wrapper">
                    ...
                    <div class="single-sidebar wow fadeInUp" data-wow-delay="0s" data-wow-duration="1s" data-wow-offset="0">
                        ...
                        <ul class="categories clearfix">
                            <li><a href="#">Car Paintings</a></li>
                            <li><a href="#">Maintenance</a></li>
                            <li><a href="#">Diagnostics</a></li>
                            <li><a href="#">Lube Oil & Filters</a></li>
                        ...
                        <ul class="popular-post">
                            <li>
                                ...
                                <div class="title-holder">
                                    <a href="#"><h5 class="post-title">High Quality Cars Only<br> We Selling</h5></a>
                            ...
                            <li>
                                ...
                                <div class="title-holder">
                                    <a href="#"><h5 class="post-title">Car Maintanence Tips <br>From Our Expets</h5></a>
                            ...
                            <li>
                                ...
                                <div class="title-holder">
                                    <a href="#"><h5 class="post-title">How Save Your Vihicle <br>Petrol and Diesel</h5></a>
