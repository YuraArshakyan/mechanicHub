...
<head>
	<meta charset="UTF-8">
	<title>Checkout || MechanicHub || Responsive HTML 5 Template</title>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <button class="thm-btn" type="submit">Login Now</button>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-lg-5 col-md-3 col-sm-4 col-xs-12">
                                        <button class="thm-btn" type="submit">Register Here</button>
                                    </div>
                                </div>   
                            </div> 
                        </form>    
