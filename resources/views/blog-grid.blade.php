...
<head>
	<meta charset="UTF-8">
	<title>Blog Grid || MechanicHub || Responsive HTML 5 Template</title>
                ...
                <div class="blog-post">
                            ...
                            <div class="single-blog-item">
                                ...
                                <div class="text-holder">
                                    ...
                                    <ul class="meta-info">
                                        ...
                                        <li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 60 Views</a></li>
                        ...
                        <div class="col-md-4">
                            <div class="single-blog-item">
                                ...
                                <div class="text-holder">
                                    ...
                                    <ul class="meta-info">
                                        <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i> Henry</a></li>
                                        <li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 25 Views</a></li>
                                        <li><a href="#"><i class="fa fa-comment" aria-hidden="true"></i> 15 Comments</a></li>
                                    </ul>
                                </div>    
                            </div>    
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="single-blog-item">
                                <div class="img-holder">
                                    <img src="images/blog/blog-grid-7.jpg" alt="Awesome Image">
                                    <div class="overlay-style-one">
                                        <div class="box">
                                            <div class="content">
                                                <a href="blog-single.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                        ...
                        <div class="col-md-4">
                            <div class="single-blog-item">
                                <div class="img-holder">
                                    <img src="images/blog/blog-grid-8.jpg" alt="Awesome Image">
                                    <div class="overlay-style-one">
                                        <div class="box">
                                            <div class="content">
                                                <a href="blog-single.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                        ...
                        <div class="col-md-4">
                            <div class="single-blog-item">
                                <div class="img-holder">
                                    <img src="images/blog/blog-grid-9.jpg" alt="Awesome Image">
                                    <div class="overlay-style-one">
                                        <div class="box">
                                            <div class="content">
                                                <a href="blog-single.html"><i class="fa fa-link" aria-hidden="true"></i></a>
                                ...
                                <div class="text-holder">
                                    ...
                                    <ul class="meta-info">
                                        <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i> Elliot</a></li>
                                        <li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 60 Views</a></li>
                                        <li><a href="#"><i class="fa fa-comment" aria-hidden="true"></i> 25 Comments</a></li>
                                    </ul>
                                </div>    
                            </div>    
                        </div>
