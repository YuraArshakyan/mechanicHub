...
<head>
	<meta charset="UTF-8">
	<title>Gallery || MechanicHub || Responsive HTML 5 Template</title>
                ...
                <nav class="main-menu pull-left">
                    ...
                    <div class="navbar-collapse collapse clearfix">
                        <ul class="navigation clearfix">
                            ...
                            <li class="dropdown current"><a href="gallery.html">Gallery</a>
                                <ul>
...
<section class="project-area project-page">
    <div class="container-fluid">
        ...
        <div class="row mar0 project-content masonary-layout filter-layout">
            ...
            <div class="single-project-item span-20per filter-item engine repairs">
            ...
            <!--Start single project item-->
            <div class="single-project-item span-20per filter-item diagnostics wheel">
                <div class="img-holder">
                    <img src="images/projects/2.jpg" alt="Awesome Image">
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/2.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <!--End single project item-->
            <!--Start single project item-->
            <div class="single-project-item span-20per filter-item wheel diagnostics air">
                <div class="img-holder">
                    <img src="images/projects/3.jpg" alt="Awesome Image">
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/3.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <!--End single project item-->
            <!--Start single project item-->
            <div class="single-project-item span-20per filter-item repairs diagnostics engine">
                <div class="img-holder">
                    <img src="images/projects/4.jpg" alt="Awesome Image">
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/4.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <!--End single project item-->
            <!--Start single project item-->
            <div class="single-project-item span-20per filter-item repairs diagnostics air">
                <div class="img-holder">
                    <img src="images/projects/5.jpg" alt="Awesome Image">
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/5.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <div class="single-project-item span-20per filter-item engine repairs">
                <div class="img-holder">
                    ...
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/6.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <!--End single project item-->
            <!--Start single project item-->
            <div class="single-project-item span-20per filter-item diagnostics wheel engine">
                <div class="img-holder">
                    <img src="images/projects/7.jpg" alt="Awesome Image">
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/7.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <div class="single-project-item span-20per filter-item wheel diagnostics air">
                <div class="img-holder">
                    ...
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/8.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <!--End single project item-->
            <!--Start single project item-->
            <div class="single-project-item span-20per filter-item repairs diagnostics">
                <div class="img-holder">
                    <img src="images/projects/9.jpg" alt="Awesome Image">
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/9.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <div class="single-project-item span-20per filter-item repairs diagnostics air">
                <div class="img-holder">
                    ...
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/10.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <div class="single-project-item span-20per filter-item engine repairs">
                <div class="img-holder">
                    ...
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/11.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <div class="single-project-item span-20per filter-item diagnostics wheel">
                <div class="img-holder">
                    ...
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/12.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <div class="single-project-item span-20per filter-item wheel diagnostics air">
                <div class="img-holder">
                    ...
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/13.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <div class="single-project-item span-20per filter-item repairs diagnostics engine">
                <div class="img-holder">
                    ...
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/14.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
            ...
            <div class="single-project-item span-20per filter-item repairs diagnostics air">
                <div class="img-holder">
                    ...
                    <div class="overlay-style-one">
                        <div class="box">
                            <div class="content">
                                <a class="zoom" href="images/projects/15.jpg" data-rel="prettyPhoto" title="MechanicHub Project">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </a>
                                <div class="bottom">
                                    <a href="gallery-single.html">Replace The Air Filter</a>
