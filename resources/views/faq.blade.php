...
<head>
	<meta charset="UTF-8">
	<title>FAQ’s || MechanicHub || Responsive HTML 5 Template</title>
            ...
            <div class="faq-content masonary-layout">
                ...
                <div class="col-md-6">
                    <div class="single-item">
                        <div class="title">
                            <h3>When Should i Replace My Fuel Filter?</h3>
                        </div>
                        <div class="text">
                            <p>To help ensure dependable, trouble-free performance, replace your fuel filter approximately every 30,000 miles or as recommended sed diam nonummy euismod in vehicle's owner's manual.</p>
                        </div>
                    </div>
                </div>
                <!--End single item-->
                ...
                <div class="col-md-6">
                    <div class="single-item">
                        <div class="title">
                            <h3>Must i get Air Conditioning Serviced?</h3>
                        </div>
                        <div class="text">
                            <p>A lot of auto repair customerss question the importance wheel alignment it really necessary? Yes, it is. Masters builder of human happiness no one rejects, dislikes, or but because rationally.</p>
                        </div>
                    </div>
                </div>
                <!--End single item-->
                ...
                <div class="col-md-6">
                    <div class="single-item">
                        <div class="title">
                            <h3>Why Does My Car Need Service If it is Running Fine?</h3>
                        </div>
                        <div class="text">
                            <p>Lowest gas prices, we have found a great video that gives sed some extra money saving tips.loves or pursues or seds desires to obtain pain of itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure.</p>
                        </div>
                    </div>
                </div>
                <!--End single item-->
                ...
                <div class="col-md-6">
                    <div class="single-item">
                        <div class="title">
                            <h3>How Long it Take To Repair My Vehicle?</h3>
                        </div>
                        <div class="text">
                            <p>Shopping around town for the lowest gas prices,have found a great video that gives some extra money saving tips loves or ut pursues or desires to because it is pain, but because occasionally.</p>
                        </div>
                    </div>
                </div>
                <!--End single item-->
                ...
                <div class="col-md-6">
                    <div class="single-item">
                        ...
                        <div class="text">
                            <p>Shopping around town for the lowest gas prices, we have found a great video that gives some extra money saving tips.loves or pursues or desires to obtain pain of itself, because it is painbecause occasionally cumstances which toil and pain can procure.</p>
                        </div>
                    </div>
                </div>
                <!--End single item-->
                ...
                <div class="col-md-6">
                    <div class="single-item">
                        ...
                        <div class="text">
                            <p>A lot of auto repair customerss question the importance wheel alignment it really necessary? Yes, it is. Masters builder of human happiness no one rejects, dislikes, or utavoids pleasures but because rationally.</p>
                        </div>
                    </div>
                </div>
                <!--End single item-->    
