                                    ...
                                    <div class="video-holder">
                                        ...
                                        <div class="overlay-gallery">
                                            <div class="icon-holder">
                                                <div class="icon">
                                                    <a class="html5lightbox" title="MechanicHub Video Gallery"
                                                       href="https://www.youtube.com/watch?v=i3F91KKbGd0">
                                ...
                                <div class="col-md-12">
                                    <div class="accordion-box">
                                        ...
                                        <div class="accordion accordion-block">
                                            <div class="accord-btn"><h4>We handle a wide range of car services</h4>
                                            </div>
                                            <div class="accord-content">
                                                <p>The master-builder of human happiness one rejects, dislikes avoid
                                                    pleasure itself, because it is pleasure, but because those who do
                                                    not know how to pursue pleasure packages and web page editors now
                                                    use uncover this mistaken idea and I will give you a complete of the
                                        ...
                                        <!--Start single accordion box-->
                                        <div class="accordion accordion-block">
                                            <div class="accord-btn active"><h4>We handle a wide range of car
                                                    services</h4></div>
                    ...
                    <div class="service-single-sidebar">
                        ...
                        <div class="single-sidebar">
                            <ul class="service-lists">
                                <li class="active"><a href="{{route('ser-single', 1)}}">Engine fixing</a></li>
                        ...
                        <div class="single-sidebar">
                            <div class="sidebar-testimonial">
                                <div class="text-box">
                                    <p>They have got my project on time with competition well organized and very
                                        experienced team of professional engineers and good leaders.</p>
                                </div>
