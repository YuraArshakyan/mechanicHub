...
<head>
	<meta charset="UTF-8">
	<title>Single Product || MechanicHub || Responsive HTML 5 Template</title>
                        ...
                        <div class="col-md-6">
                            <div class="content-box">
                                ...
                                <div class="addto-cart-box clearfix">
                                    ...
                                    <button class="thm-btn addtocart" type="submit">Add to Cart</button>
                                </div>    
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="product-tab-box">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="review">
                                    <div class="review-box">
                                        <div class="title">
                                            <h3>2 Reviews For Running Shoes</h3>
                                        </div>
                ...
                <div class="sidebar-wrapper">
                    ...
                    <div class="single-sidebar">
                        ...
                        <ul class="categories clearfix">
                            ...
                            <li><a href="#">Engine Spares</a></li>
                            <li><a href="#">Air Filter & Cleaner</a></li>
                            <li><a href="#">Wires & Plugs</a></li>
                            <li><a href="#">Tools & Motors</a></li>
                        </ul>
                    </div>
                    <!--End single sidebar-->
                    <!--Start single sidebar--> 
