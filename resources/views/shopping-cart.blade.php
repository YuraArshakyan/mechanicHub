...
<head>
	<meta charset="UTF-8">
	<title>Shopping Cart || MechanicHub || Responsive HTML 5 Template</title>
                            ...
                            <tr>
                                <td colspan="2" class="prod-column">
                                    <div class="column-box">
                                        ...
                                        <div class="title">
                                            <h3 class="prod-title">Air Filter</h3>
                                        </div>    
                                    </div>
                                </td>
                                <td class="qty">
                            ...
                            <tr>
                                <td colspan="2" class="prod-column">
                                    <div class="column-box">
                                        ...
                                        <div class="title">
                                            <h3 class="prod-title">Wheel Sets</h3>
                                        </div>    
                                    </div>
                                </td>
                                <td class="qty">
            ...
            <div class="col-md-6 col-sm-8 col-xs-12">
                <div class="apply-coupon">
                    ...
                    <div class="apply-coupon-button">
                        <button class="thm-btn" type="button">Apply Coupon</button>
                    </div>        
                </div>
            </div>
        ...
        <div class="row cart-bottom">
            <div class="col-md-6">
                <div class="calculate-shipping">
				    ...
				    <button class="thm-btn" type="submit">update Totals</button> 
                </div>
            </div>
            <!--Start cart total -->
            <div class="col-lg-6 col-md-6">
                <div class="cart-total">
                    ...
                    <button class="thm-btn checkout-btn">Proceed to Checkout</button> 
                </div>    
            </div>
            <!--End cart total -->
        </div>
