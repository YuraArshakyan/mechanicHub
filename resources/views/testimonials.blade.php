...
<head>
	<meta charset="UTF-8">
	<title>Customer Reviews || MechanicHub || Responsive HTML 5 Template</title>
        ...
        <div class="row masonary-layout">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-testimonial-item">
                    ...
                    <div class="text-holder">
                        <p>“Their performance on our project was successful. Exceptional quality & was delivered in time and budget.”</p>
                    </div>
                    <div class="bottom">
                        <div class="left pull-left">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-testimonial-item">
                    <div class="img-holder">
                        <img src="images/testimonial/4.jpg" alt="Awesome Image">
                    </div>
                    <div class="top">
                        <div class="left pull-left">
                            <h3>E. Douglas - <span>London</span></h3>
                    ...
                    <div class="text-holder">
                        <p>“These guys are just the coolest company ever! They were aware of our transported for road and tail and well special.”</p>
                    </div>
                    <div class="bottom">
                        <div class="left pull-left">
                            <h3>Basic Inspection</h3>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-testimonial-item">
                    <div class="img-holder">
                        <img src="images/testimonial/5.jpg" alt="Awesome Image">
                    </div>
                    <div class="top">
                        <div class="left pull-left">
                            <h3>Emilia Crane - <span>London</span></h3>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-testimonial-item">
                    <div class="img-holder">
                        <img src="images/testimonial/6.jpg" alt="Awesome Image">
                    </div>
                    <div class="top">
                        <div class="left pull-left">
                            <h3>Emilia Crane - <span>London</span></h3>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-testimonial-item">
                    <div class="img-holder">
                        <img src="images/testimonial/7.jpg" alt="Awesome Image">
                    </div>
                    <div class="top">
                        <div class="left pull-left">
                            <h3>E. Douglas - <span>London</span></h3>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-testimonial-item">
                    <div class="img-holder">
                        <img src="images/testimonial/8.jpg" alt="Awesome Image">
                    </div>
                    <div class="top">
                        <div class="left pull-left">
                            <h3>Emilia Crane - <span>London</span></h3>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-testimonial-item">
                    <div class="img-holder">
                        <img src="images/testimonial/9.jpg" alt="Awesome Image">
                    </div>
                    <div class="top">
                        <div class="left pull-left">
                            <h3>Emilia Crane - <span>London</span></h3>
